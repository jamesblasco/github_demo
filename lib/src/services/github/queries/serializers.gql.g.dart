...
Serializers _$serializers = (new Serializers().toBuilder()
      ...
      ..add(GIssueDetailsData_repository_issue_comments.serializer)
      ..add(GIssueDetailsData_repository_issue_comments_edges.serializer)
      ..add(GIssueDetailsData_repository_issue_comments_edges_node.serializer)
      ..add(GIssueDetailsData_repository_issue_comments_edges_node_author
          .serializer)
      ..add(GIssueDetailsData_repository_issue_labels.serializer)
      ..add(GIssueDetailsData_repository_issue_labels_edges.serializer)
      ..add(GIssueDetailsData_repository_issue_labels_edges_node.serializer)
      ...
      ..add(GIssues.serializer)
      ..add(GIssuesData.serializer)
      ..add(GIssuesData_search.serializer)
      ..add(GIssuesData_search_edges.serializer)
      ..add(GIssuesData_search_edges_node__asIssue.serializer)
      ..add(GIssuesData_search_edges_node__asIssue_author.serializer)
      ..add(GIssuesData_search_edges_node__asIssue_comments.serializer)
      ..add(GIssuesData_search_edges_node__asIssue_labels.serializer)
      ..add(GIssuesData_search_edges_node__asIssue_labels_edges.serializer)
      ..add(GIssuesData_search_edges_node__asIssue_labels_edges_node.serializer)
      ..add(GIssuesData_search_edges_node__base.serializer)
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [
            const FullType(GIssueDetailsData_repository_issue_comments_edges)
          ]),
          () => new ListBuilder<
              GIssueDetailsData_repository_issue_comments_edges>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [
            const FullType(GIssueDetailsData_repository_issue_labels_edges)
          ]),
          () => new ListBuilder<
              GIssueDetailsData_repository_issue_labels_edges>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(GIssuesData_search_edges)]),
          () => new ListBuilder<GIssuesData_search_edges>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [
            const FullType(GIssuesData_search_edges_node__asIssue_labels_edges)
          ]),
          () => new ListBuilder<
